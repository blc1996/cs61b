...
public class SList {
  ...
  public void squish() {
    // Fill in your solution here.  (Ours is eleven lines long.)
      ...
      while(CurrentNode.next != null){
          while(CurrentNode.item.equals(CurrentNode.next.item)){
  ...
  public void twin() {
    // Fill in your solution here.  (Ours is seven lines long.)
      SListNode CurrentNode, NextNode;
      CurrentNode = head;
      while(CurrentNode != null){
          if(CurrentNode.next != null){
              NextNode = new SListNode(CurrentNode.item, CurrentNode.next);
              CurrentNode.next = NextNode;
          }else{
              NextNode = new SListNode(CurrentNode.item, null);
              CurrentNode.next = NextNode;
          }
