...
public class DList extends List {
  ...
  public DList() {
    ...
    //   the `list' field (second parameter) as well.
      head = new DListNode(Integer.MIN_VALUE, null, null, null);
      head.next = head;
      head.prev = head;
      size = 0;
  }
  ...
  public void insertFront(Object item) {
    // Your solution here.  Similar to Homework 4, but now you need to specify
    //   the `list' field (second parameter) as well.
      DListNode tempNode = new DListNode(item, this, head, head.next);
  ...
  public void insertBack(Object item) {
    // Your solution here.  Similar to Homework 4, but now you need to specify
    //   the `list' field (second parameter) as well.
      DListNode tempNode = new DListNode(item, this, head.prev, head);
