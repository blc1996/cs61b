...
public class Tree234 extends IntDictionary {
  ...
  public void insert(int key) {
    // Fill in your solution here.
      ...
      while(node != null){
          if(node.keys == 3){
              if(node.parent == null){ //the root node has 3 entries
                  ...
                  node.child3 = null;
                  node.child4 = null;
                  //System.out.println(root.child2.toString());
                  if(key > root.key1)
                      node = root.child2;
                  else
                      node = root.child1;
...
//                  System.out.println(node.parent.key1);
//                  System.out.println(node.key1);
//              }

              //3-entry node is the leftmost one
              ...
              }else if(node.parent.child2 == node){ //middle
                  if(node.parent.keys == 2){
              ...
              }else if(node.parent.child3 == node){ //rightmost,
