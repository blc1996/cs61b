...
public class DList2 {
  ...
  public DList2() {
    head = new DListNode2();
    head.itemNum = Integer.MIN_VALUE;
    head.redVal = Integer.MIN_VALUE;
    head.greenVal = Integer.MIN_VALUE;
    head.blueVal = Integer.MIN_VALUE;
    head.next = head;
    head.prev = head;
    size = 0;
  }
   ...
   */
  public DList2(int Num, int R, int G, int B) {
    head = new DListNode2();
    head.itemNum = Integer.MIN_VALUE;
    head.redVal = Integer.MIN_VALUE;
    head.greenVal = Integer.MIN_VALUE;
    ...
    head.next.itemNum = Num;
    head.next.redVal = R;
    head.next.greenVal = G;
    head.next.blueVal = B;
    head.prev = head.next;
    head.next.prev = head;
    head.prev.next = head;
...
//   */
//  public DList2(int Val1, int Num1, int Val2, int Num2) {
//    head = new DListNode2();
//    head.itemNum = Integer.MIN_VALUE;
//    head.itemVal = Integer.MIN_VALUE;
//    head.next = new DListNode2();
//    head.next.itemNum = Num1;
//    head.next.itemVal = Val2;
//    head.prev = new DListNode2();
//    head.prev.itemNum = Num2;
//    head.prev.itemVal = Val2;
//    head.next.prev = head;
...
//  }
    ...
    public DListNode2 nth(int position){
        DListNode2 currentNode;
        currentNode = head;
        if(position < 1){
            return head;
   ...
   */
  public void insertFront(int Num, int R, int G, int B) {
    // Your solution here.
      DListNode2 newNode = new DListNode2(Num, R, G, B);
  ...
  public void removeFront() {
    ...
    public void insertEnd(int Num, int R, int G, int B){
        DListNode2 newNode = new DListNode2(Num, R, G, B);
